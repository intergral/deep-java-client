...
public class TracePointConfig
{
    ...
    public TracePointConfig( final String id, final String path, final int line_no, final Map<String, String> args,
    ...
    {
        return getArg( FRAME_TYPE, String.class, null );
    }

    public String getStackType()
    {
        return getArg( STACK_TYPE, String.class, null );
    }
