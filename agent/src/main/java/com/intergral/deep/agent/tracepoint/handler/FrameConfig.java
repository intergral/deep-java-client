...
{
    private static int DEFAULT_MAX_VAR_DEPTH = 5;
    private static int DEFAULT_MAX_VARIABLES = 1000;
    private static int DEFAULT_MAX_COLLECTION_SIZE = 10;
    private static int DEFAULT_MAX_STRING_LENGTH = 1024;
    private static int DEFAULT_MAX_WATCH_VARS = 100;
    private static int DEFAULT_MAX_TP_PROCESS_TIME = 100;
    ...
    public boolean shouldCollectVars( final int currentFrameIndex )
    {
        ...
        else if( this.frameType.equals( TracePointConfig.ALL_FRAME_TYPE ) )
        {
            return true;
        }
        return false;
