...
public class CFFrameProcessor extends FrameProcessor
{
    ...
    @Override
    protected String getMethodName( final StackTraceElement stackTraceElement, final Map<String, Object> variables,
    ...
    Map<String, Object> mapCFScopes( final Map<String, Object> variables )
    {
        ...
        final Map<Object, Object> scopes = ReflectionUtils.getFieldValue( pageContext, "SymTab_builtinCFScopes" );
        if( scopes == null )
        {
            return cfVars;
        }
