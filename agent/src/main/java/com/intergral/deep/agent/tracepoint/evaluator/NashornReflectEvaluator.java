 ...
 * <p>
 * 1. It can only access public methods/fields
 * 2. It can access 'private' fields only if there is a public getter
 * 3. We have to load this via reflection as we need to load from the app classloader not the boot classloader
 */
public class NashornReflectEvaluator extends AbstractEvaluator
{
    private final static Logger LOGGER = LoggerFactory.getLogger( NashornReflectEvaluator.class );
