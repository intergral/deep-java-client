...
public class ClassInfo
{
     ...
     * {@code thro} is {@code true} then a {@link ClassInfoNotFoundException} is throw when the
    ...
    static ClassInfo loadClassInfo( final String type, final ClassLoader loader, final boolean thro )
    {
        ...
        if( resource == null )
        {
            ...
            // and therefore it should not be possible for the system class loader to no be able to get the resource.
            // however this is here in case this does happen and to prevent NullPointerExceptions from later in this method.
            if( loader == null )
            {
                if( thro )
                {
    ...
    private static ClassInfo readFromResource( final String type, final URL resource, final ClassLoader loader )
            throws IOException
    {
