...
public class TextStringBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
  ...
  /**
   * Appends each item in an iterable to the builder without any separators. Appending a null iterable will have no effect. Each object is
   * appended using {@link #append(Object)}.
   *
  ...
  /**
   * Appends an array placing separators between each value, but not before the first or after the last. Appending a null array will have no
  ...
  /**
   * Appends an iterable placing separators between each value, but not before the first or after the last. Appending a null iterable will
  ...
  /**
   * Appends an object to the builder padding on the right to a fixed length. The <code>toString</code> of the object is used. If the object
   * is larger than the length, the right hand side is lost. If the object is null, null text value is used.
   *
   * @param obj     the object to append, null uses null text
   * @param width   the fixed field width, zero or negative has no effect
   * @param padChar the pad character to use
   ...
   * <p>
   * Matchers can be used to perform advanced deletion behaviour. For example you could write a matcher to delete all occurrences where the
   ...
   * <p>
   * Matchers can be used to perform advanced deletion behaviour. For example you could write a matcher to delete where the character 'a' is
   ...
   * <p>
   * Matchers can be used to perform advanced replace behaviour. For example you could write a matcher to replace all occurrences where the
   * character 'a' is followed by a number.
   *
   * @param matcher    the matcher to use to find the deletion, null causes no action
   * @param replaceStr the replace string, null is equivalent to an empty string
   ...
   * <p>
   * Matchers can be used to perform advanced replace behaviour. For example you could write a matcher to replace where the character 'a' is
   * followed by a number.
   *
   * @param matcher    the matcher to use to find the deletion, null causes no action
   * @param replaceStr the replace string, null is equivalent to an empty string
   ...
   * <p>
   * Matchers can be used to perform advanced behaviour. For example you could write a matcher to delete all occurrences where the character
   ...
   * <p>
   * This method extracts <code>length</code> characters from the builder at the specified index. If the index is negative it is treated as
   * zero. If the index is greater than the builder size, it is treated as the builder size. If the length is negative, the empty string is
   * returned. If insufficient characters are available in the builder, as much as possible is returned. Thus the returned string may be
   ...
   * <p>
   * Matchers can be used to perform advanced searching behaviour. For example you could write a matcher to find the character 'a' followed
   * by a number.
   *
   * @param matcher the matcher to use, null returns -1
   ...
   * <p>
   * The internal character array is shared between the builder and the reader. This allows you to append to the builder after creating the
   * reader, and the changes will be picked up. Note however, that no synchronization occurs, so you must perform all operations with the
   ...
   * <p>
   * To use, simply create a <code>StrBuilder</code>, call <code>asWriter</code>, and populate away. The data is available at any time using
   * the methods of the <code>StrBuilder</code>.
   * <p>
   * The internal character array is shared between the builder and the writer. This allows you to intermix calls that append to the builder
   * and write using the writer and the changes will be occur correctly. Note however, that no synchronization occurs, so you must perform
