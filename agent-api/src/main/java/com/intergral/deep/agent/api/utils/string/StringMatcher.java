...
public interface StringMatcher {
   ...
   * <p>
   * The character array may be larger than the active area to be matched. Only values in the buffer between the specified indices may be
   * accessed.
   * <p>
   * The matching code may check one character or many. It may check characters preceding <code>pos</code> as well as those after, so long
   * as no checks exceed the bounds specified.
   * <p>
